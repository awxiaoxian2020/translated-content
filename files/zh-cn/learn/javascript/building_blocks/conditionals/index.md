...
在这个例子中，您将要采取我们前面看到的三元运算符示例，并将三元运算符转换为一个 switch 语句，这将允许我们对简单的网站应用更多的选择。看看[元素表示一个控件，提供一个选项菜单：">`<select>`](/zh-CN/docs/Web/HTML/Element/select)- 这次你会看到它不是两个主题选项，而是五个。您需要在`// ADD SWITCH STATEMENT`注释下面添加一个 switch 语句：
...
- [如果...其他参考](/zh-CN/docs/Web/JavaScript/Reference/Statements/if...else)
